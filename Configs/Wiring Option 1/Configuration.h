...
#define CUSTOM_MACHINE_NAME "Frosty CR10"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  215.56
    #define DEFAULT_Ki   41.45
    #define DEFAULT_Kd  280.23
  #endif
#endif
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -58.565, -11, -1.5 }
